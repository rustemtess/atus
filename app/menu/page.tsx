                ...
                <nav className={styles.menu}>
                    <Link href='/' className={`bg-gray-100 dark:bg-[#15161B] ${styles.menuButton}`}>
                        ...
                        <div>
                            ...
                            <p className='text-gray-500 dark:text-gray-400'>Просмотр и анализ оценок</p>
                        </div>
                    </Link>
                    <Link href='/' className={`bg-gray-100 dark:bg-[#15161B] ${styles.menuButton}`}>
                        <div className='p-3.5 rounded-lg' style={{
                        ...
                        <div>
                            ...
                            <p className='text-gray-500 dark:text-gray-400'>Мой учебный график</p>
                        </div>
                    </Link>
                    <Link href='/about' className={`bg-gray-100 dark:bg-[#15161B] ${styles.menuButton}`}>
                        ...
                        <div>
                            ...
                            <p className='text-gray-500 dark:text-gray-400'>Участники проекта</p>
                        </div>
                    </Link>
                </nav>
            </MainInnerLayout>
